...
export default function Footer() {
    ...
    return (
        ...
        <footer>
            <div className="h-auto w-full flex flex-col items-center p-10 bg-grey-dark rounded-b-lg">

                <div className="flex flex-col text-sm text-grey-light font-light opacity-70 text-center">
                    <p>
