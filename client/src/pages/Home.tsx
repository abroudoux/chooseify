...
export default function Home() {
    return (
        <section className="w-full h-full min-h-screen min-w-screen bg-green flex-col-center-center px-4">
            <div className="w-full h-screen bg-black flex-col-center-center rounded-lg gap-14">
                ...
                <p className="max-w-3xl text-center text-2xl text-grey-light font-normal mb-10">
